...
public class DeliveryTimesPanel extends JPanel {
	...
	private void initPanel() {
		...
		setLayout(null);
				...
				titleLabel.setBounds(47, 11, 346, 47);
				add(titleLabel);
		...
		originTitleLabel.setBounds(30, 69, 82, 26);
		...
		destTitleLabel.setBounds(30, 116, 82, 26);
		add(destTitleLabel);
		...
		priorityTitleLabel.setBounds(30, 163, 82, 26);
		...
		priorityComboBox.setBounds(150, 163, 170, 26);
